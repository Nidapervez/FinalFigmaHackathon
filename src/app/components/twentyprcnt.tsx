            ...
            <div className="flex gap-5 max-md:flex-col">
              <div className="flex flex-col w-[45%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col items-start w-full text-base tracking-wide text-slate-300 max-md:mt-10">
                  ...
                  <button
                    className="px-12 py-5 mt-9 max-w-full text-lg tracking-wide text-white bg-pink-500 rounded-sm w-[200px] max-md:px-5 hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
                    aria-label="Shop now for Eams Sofa Compact"
                  >
                    Shop Now
                  </button>
                </div>
